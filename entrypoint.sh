...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/37b4d42f-4169-459d-bbd1-4352f373002a"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="37b4d42f-4169-459d-bbd1-4352f373002a"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/8fe4de3d-1efd-4c33-a216-f0532f870f91"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="8fe4de3d-1efd-4c33-a216-f0532f870f91"
fi
echo ${Vmess_UUID}
